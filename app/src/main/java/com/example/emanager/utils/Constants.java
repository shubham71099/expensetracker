...
public class Constants {
    ...
    public static void setCategories() {
        ...
        categories.add(new Category("Health", R.drawable.ic_health, R.color.category2));
        ...
        categories.add(new Category("Food & Drinks", R.drawable.ic_food, R.color.category6));
        categories.add(new Category("Others", R.drawable.ic_book, R.color.category7));
